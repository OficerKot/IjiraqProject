...
public static class DominoPlacementValidator
{
    ...
    public static  bool ValidatePlacement(Domino d) {
        ...
        DominoRequirements r1 = d.part1.sigilVariantData.sigilTypeData.placeRequirments;
        DominoRequirements r2 = d.part2.sigilVariantData.sigilTypeData.placeRequirments;
